...
import (
	accountsCtl "bookmark/cmd/shiori/controller/accounts"
	"bookmark/cmd/shiori/controller/auth"
	"bookmark/cmd/shiori/controller/bookmarks"
	"bookmark/cmd/shiori/controller/tags"
...
func main() {
	...
	dbPath := filepath.Join(dataDir, "shiori.db")
	...
	log.Println(fmt.Sprintf("启动成功~  %s %s", ProjectName, PortSite))
	// dev debug
